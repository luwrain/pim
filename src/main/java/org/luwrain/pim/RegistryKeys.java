...
public class RegistryKeys
{
    ...
    public String mailFolderPending()
    {
	return getProperty("mail.FolderPending");
    }

    public String mailFolderSent()
    {
	return getProperty("mail.FolderSent");
    }

    public String mailFolderInbox()
    {
	return getProperty("mail.FolderInbox");
    }
