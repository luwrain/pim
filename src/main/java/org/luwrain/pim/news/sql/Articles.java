...
final class Articles implements NewsArticles
{
	...
	try {
	    storing.execInQueue(()->{
		    ...
		    st.setString(3, article.getSourceUrl());
		    st.setString(4, article.getSourceTitle());
		    st.setString(5, article.getUri());
		    st.setString(6, article.getTitle());
		    st.setString(7, article.getExtTitle());
		    st.setString(8, article.getUrl());
		    st.setString(9, article.getDescr());
		    st.setString(10, article.getAuthor());
		    st.setString(11, article.getCategories());
		    st.setDate(12, new java.sql.Date(article.getPublishedDate().getTime()));
		    st.setDate(13, new java.sql.Date(article.getUpdatedDate().getTime()));
		    st.setString(14, article.getContent());
